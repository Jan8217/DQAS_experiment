...
def build_and_save_plot(data, filename):
	...
	plt.pcolor(data[0], data[1], data[2], norm=TwoSlopeNorm(vmin=Z.min(), vcenter=65., vmax=Z.max()), cmap='RdPu')
...
data = pd.read_csv('C:/Users/yanzh/PycharmProjects/MIT_code/csv_files/saved_data/2d_loss_grid.csv', sep=',')
print(data.values)
